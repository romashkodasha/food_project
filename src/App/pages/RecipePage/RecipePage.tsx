  ...
  useEffect(() => {
    const fetch = async () => {
      ...
      setRecipe({
        title: raw.title,
        image: raw.image,
        preparation: (raw.preparationMinutes===-1? 5 : raw.preparationMinutes),
        cooking: (raw.preparationMinutes===-1? raw.readyInMinutes-5 : raw.cookingMinutes),
        ...
        <section className="directions">
          ...
          <div className="steps">
          {
            recipe?.directions.map((dir) =>(
              <div key={dir.numStep}>
                <Text view='p-16' weight='medium'>Step {dir.numStep}</Text>
